...
<html>
<head>
<title>Giverscycler Dashboard</title>
        ...
        <div class="graphs">
     	<div class="col_3">
        	<div class="col-md-3 widget widget1">
				<a href='ph-request?AvailablePH'>
					<div class="r3_counter_box">
						<i class="pull-left fa fa-thumbs-up icon-rounded"></i>
						<div class="stats">
						  <h5><strong><?php echo $running_ph_notmerge;?></strong></h5>
						  <span><b>Available PH</b></span>
						</div>
					</div>
				</a>
        	</div>
        	<div class="col-md-3 widget widget1">
				<a href='gh-request?AvailableGH'>
					<div class="r3_counter_box">
						<i class="pull-left fa fa-exchange user1 icon-rounded"></i>
						<div class="stats">
						  <h5><strong><?php echo $running_gh_notmerge_paidfully;?></strong></h5>
						  <span><b>GH QUEUE</b></span>
						</div>
					</div>
				</a>
        	</div>
        	<div class="col-md-3 widget widget1">
				<a href='participants?All'>
					<div class="r3_counter_box">
						<i class="pull-left fa fa-users user2 icon-rounded"></i>
						<div class="stats">
						  <h5><strong><?php echo $user_row_active;?> (<?php echo $user_row;?>)</strong></h5>
        	...
        	<div class="col-md-3 widget">
				<a href='gh-request?Merge'>
					<div class="r3_counter_box">
						<i class="pull-left fa fa-money dollar1 icon-rounded"></i>
						<div class="stats">
						  <h5><strong><?php echo $running_gh_notyetpaid;?></strong></h5>
						  <span><b>Running GH</b></span>
						</div>
					</div>
				</a>
        	 </div>
