     ...
     <!-- Navigation -->
		...
		<div class="col_1">
			...
			<div class="col-md-12 stats-info">
               <br><font size='5px' color='red'><center><b>.::: MANUAL MERGING :::. </b></font><br> Don't leave participant ahead of each other, have conscience</center>
				<br>
				...
				if(isset($_GET["msg"])) {
					...
					if($msg == strtoupper(substr(md5("Order merged successfully"), -4))) {
					?>
						<div class='col-md-12'>
							
							<div class='alert alert-success' style='text-transform: uppercase; color: #000; font-size: 24px'><b>Order merged successfully</b></div>
			   ...
			   <br>
				<form method='post' action='../action'>
					<label><b>Enter PHID: </b></label>
					<input type='text' name='phid_2merge' class='form-control input-lg' autocomplete='off' required>
					<br><label><b>Enter Balance in PH: </b></label>
					<input type='text' name='amount_ph_blc' class='form-control input-lg' autocomplete='off' required>
					<br><label><b>Enter GHID: </b></label>
					<input type='text' name='ghid_2merge' class='form-control input-lg' autocomplete='off' required>
					<br><label><b>Enter GH Amount: </b></label>
					<input type='text' name='amount_gh' class='form-control input-lg' autocomplete='off' required>
					<br><label><b>Enter Balance in GH: </b></label>
				   <input type='text' name='amount_gh_blc' class='form-control input-lg' autocomplete='off' required>
				   
				   
				   <br>
				<button class='btn btn-default' name='mergeORDER' id='mergeORDER'>Merge Order &raquo;</button><br><br><br>
				</form>
            </div>
