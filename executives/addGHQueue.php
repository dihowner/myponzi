...
<html>
<head>
<title>Giverscycler Add Queue</title>
     ...
     <!-- Navigation -->
		...
		<div class="col_1">
			...
			<div class="col-md-12 stats-info">
               <br><font size='5px' color='red'><center><b>.::: Adding GH QUEUE :::. </b></center></font>
				<br><div id='result'></div>
			   <br>
				<form method='post' id='addQueue_info'>
					<label><b>Select Participant: </b></label>
				   <select class='form-control input-lg' name='addQueue_pid' id='addQueue_pid' required>
					...
					<br>
					<label><b>Amount In Wallet: </b></label>
					<input type='text' name='amount_wallet' id='amount_wallet' class='form-control input-lg' autocomplete='off'>
					<br>
					<button class='btn btn-default' name='addQueue' id='addQueue'>Add Queue &raquo;</button><br><br><br>
				</form>
            </div>
