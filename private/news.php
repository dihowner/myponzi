        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                     <h2>NEWS PORTAL</h2>   
                        <h5>Hey <b><?php echo ucfirst($participant_name);?></b> , don't be left out, read our update always. </h5><br>
                    </div>
                    ...
                    <div class="col-md-12">
							<center><font size='38px' color='#37363e'><b>NEWS UPDATE PORTAL</b></font></center><br>
						<?php
